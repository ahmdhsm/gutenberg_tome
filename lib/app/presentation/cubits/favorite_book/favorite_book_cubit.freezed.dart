...
class _$FavoriteBookStateImpl implements _FavoriteBookState {
  const _$FavoriteBookStateImpl({required final List<BookEntity> books})
      : _books = books;
  ...
  @override
  String toString() {
    return 'FavoriteBookState(books: $books)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FavoriteBookStateImpl &&
...
abstract class _FavoriteBookState implements FavoriteBookState {
  const factory _FavoriteBookState({required final List<BookEntity> books}) =
